...
- (void)viewDidLoad {
    ...
    BookmarksGroupModel *bookmarksGroupsModel = [[BookmarksGroupModel alloc] initWithIndexModel:self.indexModel bookmarksModel:bookmarksModel];
...
#pragma mark - MapViewController
    ...
    MapViewController *mapController = [[MapViewController alloc] initWithMapModel:mapModel locationModel:locationModel showClosestPoints:NO mapItem:nil];
